    ...
    public class CreateMangoAccountExample : IRunnableExample
    {
        ...
        public void Run()
        {
            ...
            TransactionBuilder txBuilder = new TransactionBuilder()
                ...
                .AddInstruction(MangoProgram.InitializeMangoAccount(MangoGroup, acc, Owner))
                .AddInstruction(MangoProgram.AddMangoAccountInfo(MangoGroup, acc, Owner, "Solnet Test"));
