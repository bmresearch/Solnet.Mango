...
{
    /// <summary>
    /// Represents the user active assets for a <see cref="HealthCache"/>.
    /// </summary>
    public class UserActiveAssets
    {
        /// <summary>
        /// The layout of the <see cref="UserActiveAssets"/> structure.
        /// </summary>
        internal static class Layout
        {
            ...
            /// <summary>
            /// The offset at which the spot market's booleans begin.
            /// </summary>
            internal const int SpotOffset = 0;

            /// <summary>
            /// The offset at which the perpetual market's booleans begin.
            /// </summary>
    ...
    /// <summary>
    /// Represents an health cache in Mango.
    /// </summary>
    public class HealthCache
    {
        ...
        internal static class Layout
        {
            ...
            /// <summary>
            /// The offset at which the user's active assets begin. 
            /// </summary>
            internal const int UserActiveAssetsOffset = 0;

            /// <summary>
            /// The offset at which the spot values begin.
            /// </summary>
            internal const int SpotOffset = 30;
        }

        /// <summary>
        /// The user's active assets.
        /// </summary>
        public UserActiveAssets ActiveAssets;

        /// <summary>
        /// The spot market's healths.
        /// </summary>
        public List<Tuple<I80F48, I80F48>> Spot;

        /// <summary>
        /// The perpetual market's healths.
        /// </summary>
